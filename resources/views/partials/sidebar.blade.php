<aside class="w-56 bg-white border-r border-bank-border flex flex-col shrink-0">
    ...
    <div class="px-5 pt-6 pb-4">
        ...
        <h2 class="text-lg font-extrabold text-bank-red mt-0.5 uppercase tracking-tight">{{ Auth::user()->name ?? 'User' }}</h2>
        <span class="inline-flex items-center gap-1 bg-emerald-50 text-emerald-600 text-[10px] font-bold px-2.5 py-1 rounded-full mt-2 border border-emerald-200">
    ...
    <div class="px-4 pb-4 mt-auto space-y-4">
        ...
        <div class="flex items-center justify-center gap-5 pt-2 pb-1">
            <a href="#" class="flex flex-col items-center gap-1 text-gray-400 hover:text-gray-600 transition-colors">
