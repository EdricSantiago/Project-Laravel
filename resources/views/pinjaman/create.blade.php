    ...
    <div class="max-w-lg mx-auto py-8 px-4">
        ...
        <div class="bg-white rounded shadow p-6">
            <form action="{{ route('pinjaman.store') }}" method="POST">
                ...
                <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded text-sm font-medium">Ajukan</button>
                <a href="{{ route('pinjaman.index') }}" class="block text-center w-full mt-2 border border-gray-400 text-gray-600 hover:bg-gray-50 py-2 rounded text-sm">Batal</a>
            </form>
        </div>
