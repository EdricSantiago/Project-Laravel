...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="max-w-lg mx-auto py-8 px-4">
        ...
        <h5 class="text-xl font-semibold text-gray-800 mb-6">Ajukan Pinjaman</h5>
        ...
        <div class="bg-white rounded shadow overflow-hidden">
            <div class="bg-red-700 px-4 py-3">
                <p class="text-white text-xs uppercase tracking-wide font-medium">Formulir Pengajuan</p>
            </div>
            <div class="p-6">
                <form action="{{ route('pinjaman.store') }}" method="POST">
                    ...
                    <button type="submit" class="w-full bg-red-700 hover:bg-red-800 text-white py-2 rounded text-sm font-medium transition">Ajukan</button>
                    <a href="{{ route('pinjaman.index') }}" class="block text-center w-full mt-2 border border-gray-400 text-gray-600 hover:bg-gray-50 py-2 rounded text-sm transition">Batal</a>
                </form>
            </div>
        </div>
